...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create(\SnakeCodder\Testimonials\Model\Testimonial::class)->load($id);
            if (!$model->getId() && $id) {
            ...
            try {
                ...
                $this->dataPersistor->clear('snakecodder_testimonials_testimonial');
            ...
            $this->dataPersistor->set('snakecodder_testimonials_testimonial', $data);
